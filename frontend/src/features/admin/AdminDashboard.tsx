...
import { Box, Typography, Grid, Paper, Card, CardContent, Avatar, CircularProgress, Chip, Stack, Button, Divider } from '@mui/material';
...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        const [usersRes, logsRes, utilitiesRes] = await Promise.all([api.get('/api/v1/admin/users'), api.get('/api/v1/admin/logs'), api.get('/api/v1/admin/utilities')]);
  ...
  const summaryCards = [{
    ...
    subtitle: 'Total System Audits',
    icon: <NotificationsActiveIcon fontSize="large" />,
    bgColor: '#eff6ff',
    iconColor: '#2563eb'
  }];
  const departmentCards = [{
    name: 'Milk Shop Management',
    desc: 'Manage suppliers, GRNs, stock ledger, and daily cash handovers.',
    icon: <StorefrontIcon fontSize="large" />,
    color: '#ea580c'
  }, {
    name: 'Room Section Management',
    desc: 'Oversee room bookings, occupancy matrix, and daily remittances.',
    icon: <HotelIcon fontSize="large" />,
    color: '#0284c7'
  }, {
    name: 'Beer Garden Management',
    desc: 'Track liquor issuance, supplier payments, and bar commissions.',
  ...
  return <Box sx={{
    ...
    mx: 'auto'
      ...
      mb: 5
                ...
                {summaryCards.map((card, index) => <Grid size={{
        xs: 12,
        sm: 6,
        md: 3
      }} key={index}>
      ...
      mb: 5
        ...
        lg: 8
          ...
          color: '#1e293b',
          mb: 2
        }}>Business Departments</Typography>
                    <Grid container spacing={2}>
                        {departmentCards.map((dept, idx) => <Grid size={{
            xs: 12,
            sm: 6
          }} key={idx}>
                                <Card sx={{
              borderRadius: 3,
              borderLeft: `6px solid ${dept.color}`,
              ...
              height: '100%'
                  ...
                  mb: 2,
                  minHeight: 40
                }}>{dept.desc}</Typography>
                                        <Chip label="Operational" size="small" sx={{
        ...
        lg: 4
          ...
          height: '100%'
                        ...
                        <Stack spacing={2}>
                            {canMutateBusinessData && <Button variant="contained" startIcon={<AddIcon />} onClick={() => navigate('/admin/users')} sx={{
              bgcolor: '#b91c1c',
              '&:hover': {
                bgcolor: '#991b1b'
              },
              ...
              py: 1.5
                            ...
                            <Button variant="outlined" startIcon={<ReceiptIcon />} onClick={() => navigate('/admin/utilities')} sx={{
              color: '#b91c1c',
              borderColor: '#b91c1c',
              '&:hover': {
                bgcolor: '#fef2f2',
            ...
            alignItems: 'center'
              ...
              alignItems: 'flex-start'
                ...
                mt: 0.8
                                ...
                                <Typography variant="body2" sx={{
                color: '#7c2d12'
              }}>Check daily cash handover records against physical cash collected.</Typography>
                            </Box>
                            <Box sx={{
              display: 'flex',
              gap: 1.5,
              alignItems: 'flex-start'
                ...
                mt: 0.8
                                ...
                                <Typography variant="body2" sx={{
                color: '#7c2d12'
              }}>Review room remittance reports at the end of each receptionist shift.</Typography>
                            </Box>
                            <Box sx={{
              display: 'flex',
              gap: 1.5,
              alignItems: 'flex-start'
                ...
                mt: 0.8
                                ...
                                <Typography variant="body2" sx={{
                color: '#7c2d12'
              }}>Verify utility allocations monthly before submitting final ledger reports.</Typography>
                            </Box>
                            <Box sx={{
              display: 'flex',
              gap: 1.5,
              alignItems: 'flex-start'
                ...
                mt: 0.8
                                ...
                                <Typography variant="body2" sx={{
                color: '#7c2d12'
              }}>Monitor stock and sales summaries to ensure reorder levels are maintained.</Typography>
                            </Box>
                        </Stack>
                    </Paper>
                </Grid>
      ...
      justifyContent: 'center'
        ...
        gap: 1
          ...
          color: '#64748b',
          fontWeight: 600
        }}>Backend Services: Online</Typography>
                </Box>
                <Box sx={{
        display: 'flex',
        alignItems: 'center',
